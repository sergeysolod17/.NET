...
{
    public partial class MechanismAnalys
    {
#region InputData
        ...
        {
            public double x_BVn, y_BVn, x_CVn, y_CVn, v_CBn, X_S2Vn, Y_S2Vn, X_S3Vn, Y_S3Vn, X_S4Vn, Y_S4Vn;
        }
        public struct PlanAccelerationsParameters
        {
            public double X_pi, Y_pi, a_n2n, a_tau2n, beta_2nn, beta_tau2n, X_Ban, Y_Ban, a_n3n, beta_3nn;
            public double X_CB3n, Y_CB3n, a_n4n, beta_4nn,X_CB4n, Y_CB4n, X_Can, Y_Can, X_S2an, Y_S2an, X_S3an;
            public double  Y_S3an, X_S4an, Y_S4an, a_tau3n, beta_tau3n, a_tau4n, beta_tau4n;
        }
...
#region inside_vars     
        ...
        private static double l2, l3, l4, l5, l_AD, l_AS_2, l_BS_3, l_DS_4, omega, epsilon;
...
#region CalculationFunctions
        ...
        public void CalculationAcceleration(ref PlanAccelerationsParameters res)
        {
            ...
            OperatorFunction.F4(res.X_pi, res.Y_pi, res.X_Ban, res.Y_Ban, ref a_Bn);
            OperatorFunction.F3(res.X_pi, res.Y_pi, res.X_Ban, res.Y_Ban, a_Bn, ref res.beta_2nn);
            ...
            OperatorFunction.F2(res.X_pi, res.Y_pi, res.a_n4n, res.beta_4nn, ref res.X_CB4n, ref res.Y_CB4n);
            ...
            OperatorFunction.F4(res.X_pi, res.Y_pi, res.X_Can, res.Y_Can, ref a_Cn);
            OperatorFunction.F4(res.X_Ban, res.Y_Ban, res.X_Can, res.Y_Can, ref a_CBn);
            OperatorFunction.F5(res.X_pi, res.Y_pi, res.X_Ban, res.Y_Ban, l_AS_2, l2 - l_AS_2, 1, ref res.X_S2an, ref res.Y_S2an);
            OperatorFunction.F4(res.X_pi, res.Y_pi, res.X_S2an, res.Y_S2an, ref a_S2n);
            beta_S2n = beta_2n;
            ...
            OperatorFunction.F4(res.X_pi, res.Y_pi, res.X_S3an, res.Y_S3an, ref a_S3n);
            OperatorFunction.F3(res.X_pi, res.Y_pi, res.X_S3an, res.Y_S3an, a_S3n, ref beta_S3n);
            //Визначаємо прискорення точки S4
            OperatorFunction.F5(res.X_pi, res.Y_pi, res.X_Ban, res.Y_Ban, l_DS_4, l4 - l_DS_4, 1, ref res.X_S4an, ref res.Y_S4an);
            OperatorFunction.F4(res.X_pi, res.Y_pi, res.X_S4an, res.Y_S4an, ref a_S4n);
            OperatorFunction.F3(res.X_pi, res.Y_pi, res.X_S4an, res.Y_S4an, a_S4n, ref beta_S4n);
